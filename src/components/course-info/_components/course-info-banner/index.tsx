...
export const CourseInfoBanner = memo(function CourseInfoBanner() {
  return (
    <div className={cn(`${BLOCK_NAME}__banner`)}>
      <div className={cn(`${BLOCK_NAME}__banner-text`)}>
        ...
        <Text
          size="p"
          text="Станьте самым желанным кандидатом на&nbsp;собеседованиях в компаниях Европы и&nbsp;Америки  — от&nbsp;самопрезентации до оффера."
        />
